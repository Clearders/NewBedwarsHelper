...
public class ConfigMenuScreen extends Screen {
    ...
    private static final Component MISC_CONFIG_TEXT = Component.translatable("screen.newbedwarshelper.config.misc");
    ...
    protected void init() {
        ...
        helper.addChild(Button.builder(ISP_CONFIG_TEXT, button -> this.minecraft.gui.setScreen(new IspConfigScreen(this.minecraft, this)))
                .width(BUTTON_WIDTH)
                .build(), gridLayout.newCellSettings().paddingTop(5));
        helper.addChild(Button.builder(MISC_CONFIG_TEXT, button -> this.minecraft.gui.setScreen(new MiscConfigScreen(this.minecraft, this)))
                .width(BUTTON_WIDTH)
                .build(), gridLayout.newCellSettings().paddingTop(5));
